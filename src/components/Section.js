...
const Section = () => {
    return ( 
        ...
        <section className="bg-gray-100 pt-64 pb-10 px-6 md:px-16">
            <h2 className="text-main font-bold text-xl md:text-5xl py-5 text-center font-rubik"  data-aos="zoom-in" data-aos-offset="260" data-aos-duration="2500" data-aos-delay="400">Trade securely and manage the high growth cryptocurrencies.</h2>
