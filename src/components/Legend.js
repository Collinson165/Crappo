        ...
        <section className="legend">
            ...
            <div className="flex justify-center py-10 md:py-20 bg-gradient-to-t from-main to-card">
                <div className="rounded-xl bg-button container mx-2 md:mx-5 lg:mx-10 max-w-6xl p-5 md:p-10 md:flex justify-between relative overflow-hidden" data-aos="zoom-in" data-aos-offset="330" data-aos-duration="1000">
                    ...
                    <form action="" className="md:flex items-center">
                        
                        <input type="email" placeholder="Enter your email" className="bg-button border-b md:ml-20 md:mr-10 my-2 border-white block" />
                        <button className="bg-white text-main rounded-full md:mx-5 my-2 px-5 py-2 block">Subcribe</button>
                        <svg className="absolute bottom-0 right-0 animate-pulse" width="135" height="135" viewBox="0 0 140 135" fill="none" xmlns="http://www.w3.org/2000/svg">
