...
const Legend = () => {
    return ( 
        <section className="legend">
            <h2 className="font-bold font-rubik text-3xl py-20 px-32 text-center"  data-aos="zoom-in" data-aos-offset="280" data-aos-duration="2500" data-aos-delay="400">Market sentiments, portfolio and run <br /> the infrastructure of your choice</h2>
            <div className="grid grid-cols-2 py-10">
                <div className="col-span-2 md:col-span-1  flex justify-center  flex-col pl-20 pr-36"  data-aos="zoom-in" data-aos-offset="300" data-aos-duration="2500" data-aos-delay="400">
                ...
                <div className="col-span-2 md:col-span-1  flex justify-center  flex-col pl-20 pr-36"  data-aos="fade-up" data-aos-offset="305" data-aos-duration="2500" data-aos-delay="400">
                ...
                <div className="col-span-2 md:col-span-1  flex justify-center  flex-col pl-20 pr-36"  data-aos="fade-up" data-aos-offset="316" data-aos-duration="2500" data-aos-delay="400">
            ...
            <div className="flex justify-center py-20 bg-gradient-to-t from-main to-card">
                <div className="rounded-xl bg-button max-w-6xl p-10 flex justify-between relative" data-aos="zoom-in" data-aos-offset="330" data-aos-duration="2500">
                    <div className="">
                    ...
                    <form action="" className="flex items-center">
                        ...
                        <input type="email" placeholder="Enter your email" className="bg-button border-b ml-20 mr-10 border-white" />
