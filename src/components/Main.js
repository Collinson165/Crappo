    ...
    return ( 
        <main className="px-4 md:px-16">
            ...
            <div className="grid grid-cols-3 mx-auto py-10">
                <div className="col-span-3 md:col-span-1 flex md:justify-center items-center py-2" data-aos="fade-up" data-aos-offset="120" data-aos-duration="2500" data-aos-delay="400">
                ...
                <div className="col-span-3 md:col-span-1 flex md:justify-center items-center py-2" data-aos="fade-up" data-aos-offset="130" data-aos-duration="2500" data-aos-delay="400">
                ...
                <div className="col-span-3 md:col-span-1 flex md:justify-center items-center py-2" data-aos="fade-up" data-aos-offset="150" data-aos-duration="2500" data-aos-delay="400" data-aos-easing="ease">
            ...
            <div className="grid grid-cols-2">
                ...
                <div className="col-span-2 md:col-span-1 px-5 md:px-16 flex justify-center flex-col"  data-aos="fade-up" data-aos-offset="130" data-aos-duration="2500" data-aos-delay="400">
